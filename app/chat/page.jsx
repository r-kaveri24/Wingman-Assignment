  ...
  const handleSendMessage = async () => {
    ...
    if (!userId) {
      ...
      setMessages((prevMessages) => [
        ...prevMessages,
        {
          text: "Hi, I'm Wingman AI Assistant. How can I help you?",
          sender: "bot",
          time: currentTime,
        },
      ]);
  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center h-screen min-h-[500px] w-full bg-gray-100 px-4 py-5 md:px-10">
        <div
          className="bg-white w-full rounded-lg shadow-lg flex flex-col overflow-hidden"
          style={{ height: "600px" }}
        >
          <div className="bg-[#115E56] text-white p-4 text-center font-semibold text-lg">
            Wingman Chatbot
          </div>
