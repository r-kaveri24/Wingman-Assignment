...
const Glance = () => {
  return (
    <div
      className={` w-[100%] flex items-end ml-14 justify-center overflow-x-scroll overflow-hidden`}
    >
      <div className={` w-[95%] mt-32  flex  justify-around   `}>
        <div
          className={` ${styles.shadow}  w-[100%]  flex  flex-col rounded-[20px] items-center `}
        >
          <div
            className={` w-[95%] h-full flex  flex-col items-center justify-center `}
          >
            ...
            <div className="h-fit w-[100%] grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8 md:grid-cols-2 lg:grid-cols-3 place-content-center place-items-center ">
            ...
            <div className="flex gap-6 w-full items-center justify-around mt-8 flex-wrap">
              <div
                className="w-full md:w-[684px] h-[455px] rounded-[20px] flex items-center justify-center"
                style={{
                  boxShadow:
                    "0px 5px 22px 0px #0000000A, 0px 0px 0px 1px #0000000F",
                }}
              >
                <MixedChart />
              </div>
              ...
              <div
                className="w-[260px] h-[455px] rounded-[20px] flex flex-col items-center justify-center gap-6"
                style={{
                  boxShadow:
                    "0px 5px 22px 0px #0000000A, 0px 0px 0px 1px #0000000F",
                }}
              ...
              <div
                className={` ${styles.linerGradiant} w-[260px] h-[455px] rounded-[20px] relative`}
                style={{
                  boxShadow:
                    "0px 5px 22px 0px #0000000A, 0px 0px 0px 1px #0000000F",
                }}
              >
                <Forcast />
                <div className="w-full h-full overflow-hidden bg-[#109c89] relative rounded-[20px]">
