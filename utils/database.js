...
export const cardsData = [
  {
    ...
    discription: (
      <p className="flex gap-2 text-sm items-center">
        <img src="TrendUp.png" alt="" className="w-6 h-6" />
  ...
  },
  {
    ...
    discription: (
      <p className="flex gap-2 text-sm items-center">
        <img src="TrendDown.png" alt="" className="w-6 h-6" />
        <span className="text-[#F04438]">15%</span> increase
      </p>
    ),
    icon: (
      <img
